...
public class TypeController {
    ...
    @PostMapping("/filter")
    public ResponseEntity<Page<TypeReadDto>> getTypes(@PageableDefault(page = 0, size = 20, sort = "id", direction = Direction.DESC) Pageable pageable, @Valid @RequestBody TypeFilterDto filter) {
    ...
    @PostMapping("/id")
    public ResponseEntity<TypeReadDto> getTypeById(@Valid @RequestBody TypeFilterDto filter) {
    ...
    @PostMapping("/count")
    public ResponseEntity<Long> getTypeCount(@Valid @RequestBody TypeFilterDto filter) {
    ...
    public ResponseEntity<Page<TypeEffectivenessReadDto>> getTypeEffectiveness(@PageableDefault(page = 0, size = 20, sort = "id", direction = Direction.DESC) Pageable pageable, @Valid @RequestBody TypeEffectivenessFilterDto filter) {
    ...
    public ResponseEntity<Long> getTypeEffectivenessCount(@Valid @RequestBody TypeEffectivenessFilterDto filter) {
