...
public class SpeciesController {
    ...
    @PostMapping("/filter")
    public ResponseEntity<Page<PokemonSpeciesReadDto>> getSpecies(@PageableDefault(page = 0, size = 20, sort = "sortOrder", direction = Direction.ASC) Pageable pageable, @Valid @RequestBody PokemonFilterDto filter) {
    ...
    @PostMapping("/id")
    public ResponseEntity<PokemonSpeciesReadDto> getSpeciesById(@Valid @RequestBody PokemonFilterDto filter) {
    ...
    public ResponseEntity<Page<PokemonSpeciesSummaryDto>> getSpeciesSummaries(@PageableDefault(page = 0, size = 20, sort = "sortOrder", direction = Direction.ASC) Pageable pageable, @Valid @RequestBody PokemonFilterDto filter) {
    ...
    @PostMapping("/count")
    public ResponseEntity<Long> getSpeciesCount(@Valid @RequestBody PokemonFilterDto filter) {
